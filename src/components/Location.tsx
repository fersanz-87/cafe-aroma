        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold text-primary-dark">Dirección</h3>
                <p className="mt-1 text-warm-gray">
                  Av. Miguel Alemán 456, Col. Centro<br />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold text-primary-dark">Horarios</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-heading text-lg font-semibold text-primary-dark">Teléfono</h3>
                <p className="mt-1 text-warm-gray">
